...
import com.enzer.wilsonsmpblocks.items.ItemBlockDaubWattle;

/**
 * Block representing daub & wattle.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
 * @since 1.8
 */
public class BlockDaubWattle extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "daubwattle";
	private static final PropertyEnum VARIANT = PropertyEnum.create("variant",
			Type.class);

	/**
	 * Types of daub & wattle.
	 * 
	 * @author Tuxide
	 *
	 */
	...
	public static enum Type implements HasMetadata {
		WHITEEMPTY(0, "whiteempty"), WHITELEFT(1, "whiteleft"), WHITERIGHT(2,
				"whiteright"), WHITECROSS(3, "whitecross"), GRAYEMPTY(4,
				"grayempty"), GRAYLEFT(5, "grayleft"), GRAYRIGHT(6, "grayright"), GRAYCROSS(
				7, "graycross"), BROWNEMPTY(8, "brownempty"), BROWNLEFT(9,
				"brownleft"), BROWNRIGHT(10, "brownright"), BROWNCROSS(11,
				"browncross"), BRICKLEFT(12, "brickleft"), BRICKRIGHT(13,
				"brickright"), BRICKCROSS(14, "brickcross");
	...
	/**
	 * Registers all daub & wattle with Forge.
	 */
	public static void register() {
		final BlockDaubWattle blockDaubWattle = new BlockDaubWattle();
		blockDaubWattle.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockDaubWattle, ItemBlockDaubWattle.class,
				NAME);
	}
}
