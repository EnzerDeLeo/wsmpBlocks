...
import com.enzer.wilsonsmpblocks.items.ItemBlockRopeTop;

/**
 * Block representing a rope.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
 * @since 1.8
 */
public class BlockRopeTop extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "ropetop";
	...
	public BlockRopeTop() {
		...
		setDefaultState(blockState.getBaseState()
				.withProperty(VARIANT, Type.NETTOP));
	...
	/**
	 * Registers all ropes with Forge.
	 */
	public static void register() {
		final BlockRopeTop blockRopeTop = new BlockRopeTop();
		blockRopeTop.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockRopeTop, ItemBlockRopeTop.class, NAME);
	}
}
