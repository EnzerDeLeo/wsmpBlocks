...
import com.enzer.wilsonsmpblocks.items.ItemBlockLantern;

/**
 * Block representing a lantern.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
...
public class BlockLantern extends Block {
	...
	public static enum Type implements HasMetadata {
		CANDLE(0, "candle"), BLUE(1, "blue"), GREEN(2, "green"), RED(3, "red"), YELLOW(
				4, "yellow"), NETHER(5, "nether");
	...
	/**
	 * Registers all lanterns with Forge.
	 */
	public static void register() {
		final BlockLantern blockLantern = new BlockLantern();
		blockLantern.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockLantern, ItemBlockLantern.class, NAME);
	}
}
