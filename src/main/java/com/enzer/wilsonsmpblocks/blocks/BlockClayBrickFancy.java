...
import com.enzer.wilsonsmpblocks.items.ItemBlockClayBrickFancy;
 ...
 * @since 1.8
 */
public class BlockClayBrickFancy extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "claybrickfancy";
	private static final PropertyEnum VARIANT = PropertyEnum.create("variant",
			Type.class);

	/**
	 * Types of fancy clay brick.
	 * 
	 * @author Tuxide
	 *
	 */
	...
	public static void register() {
		final BlockClayBrickFancy blockClayBrickFancy = new BlockClayBrickFancy();
		blockClayBrickFancy.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockClayBrickFancy,
				ItemBlockClayBrickFancy.class, NAME);
	}
}
