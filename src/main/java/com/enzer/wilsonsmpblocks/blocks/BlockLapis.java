...
import com.enzer.wilsonsmpblocks.items.ItemBlockLapis;

/**
 * Block representing a lapis block.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
 * @since 1.8
 */
public class BlockLapis extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "lapis";
	private static final PropertyEnum VARIANT = PropertyEnum.create("variant",
			Type.class);

	/**
	 * Types of lapis blocks.
	 * 
	 * @author Tuxide
	 *
	 */
	...
	public static enum Type implements HasMetadata {
		BRICK(0, "brick"), SMOOTH(1, "smooth"), SANDSTONE(2, "sandstone"), SMOOTHSTONE(
				3, "smoothstone");
	...
	/**
	 * Registers all lapis blocks with Forge.
	 */
	public static void register() {
		final BlockLapis blockLapis = new BlockLapis();
		blockLapis.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockLapis, ItemBlockLapis.class, NAME);
	}
}
