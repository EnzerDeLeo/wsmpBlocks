...
import com.enzer.wilsonsmpblocks.items.ItemBlockObsidian;
...
public class BlockObsidian extends Block
{
	...
	{
		BRICK(0, "brick"), CHISELED(1, "chiseled");
	...
	public BlockObsidian()
	{
		...
		setHardness(2F);
		setResistance(2000F);
		setDefaultState(blockState.getBaseState().withProperty(VARIANT, Type.BRICK));
	...
	/**
	 * Registers all obsidian blocks with Forge.
	 */
	public static void register()
	{
		final BlockObsidian blockObsidian = new BlockObsidian();
		blockObsidian.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockObsidian, ItemBlockObsidian.class, NAME);
	}
}
