...
import com.enzer.wilsonsmpblocks.items.ItemBlockMetalCube;

/**
 * Block representing a variety of metal cubes.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
 * @since 1.8
 */
public class BlockMetalCube extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "metalcube";
	private static final PropertyEnum VARIANT = PropertyEnum.create("variant",
			Type.class);

	/**
	 * Types of metal cubes.
	 * 
	 * @author Tuxide
	 *
	 */
	...
	public static enum Type implements HasMetadata {
		TIN(0, "tin"), COPPER(1, "copper"), OXICOPPER(2, "oxicopper"), BRONZE(
				3, "bronze"), IRONRUST(4, "ironrust"), IRONWROUGHT(5,
				"ironwrought"), IRONWROUGHTRUST(6, "ironwroughtrust"), STEEL(7,
				"steel"), SILVER(8, "silver"), MITHRAL(9, "mithral"), IRONBLOOD(
				10, "ironblood"), ORICHALCUM(11, "orichalcum");
	...
	public static void register() {
		final BlockMetalCube blockMetalCube = new BlockMetalCube();
		blockMetalCube.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockMetalCube, ItemBlockMetalCube.class,
				NAME);
	}
}
