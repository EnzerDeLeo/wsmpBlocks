...
import com.enzer.wilsonsmpblocks.items.ItemBlockClayBrickPainted;

/**
 * Block representing a painted clay brick.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
 * @since 1.8
 */
public class BlockClayBrickPainted extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "claybrickpainted";
	private static final PropertyEnum VARIANT = PropertyEnum.create("variant",
			Type.class);

	/**
	 * Types of painted clay brick.
	 * 
	 * @author Tuxide
	 *
	 */
	...
	public static enum Type implements HasMetadata {
		RAW(0, "raw"), BLUE(1, "blue"), CYAN(2, "cyan"), GREEN(3, "green"), LIGHTBLUE(
				4, "lightblue"), LIME(5, "lime"), MAGENTA(6, "magenta"), ORANGE(
				7, "orange"), PINK(8, "pink"), PURPLE(9, "purple"), RED(10,
				"red"), WHITE(11, "white"), YELLOW(12, "yellow");
	...
	/**
	 * Registers all fancy clay bricks with Forge.
	 */
	public static void register() {
		final BlockClayBrickPainted blockClayBrickPainted = new BlockClayBrickPainted();
		blockClayBrickPainted.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockClayBrickPainted,
				ItemBlockClayBrickPainted.class, NAME);
	}
}
