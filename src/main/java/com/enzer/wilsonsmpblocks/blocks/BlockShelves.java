...
import com.enzer.wilsonsmpblocks.items.ItemBlockShelves;
...
public class BlockShelves extends Block {
	...
	public static enum Type implements HasMetadata {
		ABANDONED(0, "abandoned"), ALCHEMY(1, "alchemy"), BOTTLE(2, "bottle"), EMPTY(
				3, "empty"), FOOD(4, "food");
	...
	/**
	 * Registers all shelves with Forge.
	 */
	public static void register() {
		final BlockShelves blockshelves = new BlockShelves();
		blockshelves.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockshelves,
				ItemBlockShelves.class, NAME);
	}
}