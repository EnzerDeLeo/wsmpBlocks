...
import com.enzer.wilsonsmpblocks.items.ItemBlockDaubWattleColor;

/**
 * Block representing a colored daub & wattle.
 * 
 * @author Enzer
 * @author Tuxide
 * @version %I%, %G%
 * @since 1.8
 */
public class BlockDaubWattleColor extends Block {
	@SuppressWarnings("javadoc")
	public static final String NAME = "daubwattlecolor";
	private static final PropertyEnum VARIANT = PropertyEnum.create("variant",
			Type.class);

	/**
	 * Types of colored daub & wattle.
	 * 
	 * @author Tuxide
	 *
	 */
	...
	public static enum Type implements HasMetadata {
		BLUE(0, "blue"), CYAN(1, "cyan"), GREEN(2, "green"), LIGHTBLUE(3,
				"lightblue"), LIME(4, "lime"), MAGENTA(5, "magenta"), ORANGE(6,
				"orange"), PINK(7, "pink"), PURPLE(8, "purple"), RED(9, "red"), YELLOW(
				10, "yellow");
	...
	/**
	 * Registers all colored daub & wattle with Forge.
	 */
	public static void register() {
		final BlockDaubWattleColor blockDaubWattleColor = new BlockDaubWattleColor();
		blockDaubWattleColor.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockDaubWattleColor,
				ItemBlockDaubWattleColor.class, NAME);
	}
}
