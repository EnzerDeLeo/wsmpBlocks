...
import com.enzer.wilsonsmpblocks.items.ItemBlockRope;
...
public class BlockRope extends Block {
	...
	public static enum Type implements HasMetadata {
		NS(0, "ns"), EW(1, "ew"), UD(2, "ud"), CONNECT(3, "connect"), ANCHOR(4,
				"anchor"), NETNS(5, "netns"), NETSN(6, "netsn"), NETEW(7,
				"netew"), NETWE(8, "netwe");
	...
	public static void register() {
		final BlockRope blockRope = new BlockRope();
		blockRope.setUnlocalizedName(NAME);
		GameRegistry.registerBlock(blockRope, ItemBlockRope.class, NAME);
	}
}
